...
def get_params():
    ...
    parser.add_argument('--Cmodel_path', default='./experiments/models/train_MSA_VOC_sal/2024-xx-xx xx_xx_xx.pth', type=str)  #
    ...
    parser.add_argument('--tag', default='evaluate_SAL', type=str)
...
class evaluator:
    def __init__(self, dataset='voc12', domain='train', SP_CAM=True, save_np_path=None, savepng_path=None,
                 muti_scale=False, th_list=list(np.arange(0.2, 0.5, 0.1)), refine_list=range(0, 50, 10)) -> None:
                ...
                for renum in self.refine_list:
                    ...
                    for th in self.th_list:
                        ...
                        for batch_index in range(images.size()[0]):
                            ...
                            if (step == 600) or (step == 200) or (step == 100):
